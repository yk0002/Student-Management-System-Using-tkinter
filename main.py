...
connector.execute(
"CREATE TABLE IF NOT EXISTS SCHOOL_MANAGEMENT (STUDENT_ID INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, NAME VARCHAR(255), EMAIL VARCHAR(255), PHONE_NO INT, GENDER VARCHAR(255), DOB INT, STREAM VARCHAR(255))"
)
...
main = Tk()
main.title('YK Student Management System')
main.geometry('1000x600')
main.resizable(0, 0)
# Creating the background and foreground color variables
lf_bg = 'SteelBlue1' # bg color for the left_frame
cf_bg = 'DodgerBlue4' # bg color for the center_frame
...
Label(main, text="STUDENT MANAGEMENT SYSTEM", font=headlabelfont, bg='cadet blue').pack(side=TOP, fill=X)
...
Label(right_frame, text='Students Records', font=headlabelfont, bg='seashell2', fg='black').pack(side=TOP, fill=X)
